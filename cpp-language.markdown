...
## Chapter 1
+ Cpp is a general purpose programming language with a bias toward the system programming (the system programming term mean that directly uses the hardware resources)
+ The main ideal of programming as for other higher-level language is to express the design in code (represent anything in the code).
