...
#### Chapter 9: Menjawab Pertanyaan Yang Lebih Mudah
* Jika jawaban memuaskan untuk satu pertanayaan sulit ditemukan dengan cepat, maka Sistem 1 akan mencari pernyataan terkait yang lebih mudah lalu menjawabnya.
...
#### Chapter 25: Kekeliruan-Kekeliruan Bernoulli
* Teori harapan utlitas digunakan sebagai logika yang menentukan bagaimana keputusan seharusnya dibuat, dan sebagai deskripsi cara Ekon (Speies yang berbeda dari manusia) membuat pilihan.
* Sebagian besar orang tidak menyukai resiko (sebuah peluang untuk menerima kerugian yang mungkin). Maka dari hal itu, orang-orang akan memilih yang pasti ketika dihadapkan pada sebuah pilihan.
* Teori Bernoulli yang merupakan teori harapan utilitas, mengasumsikan bahwa utilitas kekayaan adalah hal yang membuat orang lebih / kurang bahagia, namun kebahagiaan atau kesedihan ditentukan oleh _perubahan terbaru_ dalam kekayaan relatif terhadap rujukan kekayaan awal.
* Buta akibat teori adalah kondisi dimana sekalinya kita menerima sebuah teori dan menggunakannya sebagai alat berpikir, sukar sekali memperhatikan cacat pada teori tersebut.

#### Chapter 26: Teori Prospek
* Dalam teori utilitas, utilitas suatu keuntungan dinilai dengan membandingkan utilitas dua keadaan kekayaan. Contohnya adalah utilitas mendapatkaan tambahan $500 ketika kekayaan Anda $1 juta.
* Kelemahan dari Teori Bernoulli adalah model teori ini terlalu sederhana dan kaku, dimana di dalam Teori Bernoull, kita hanya perlu keadaan kekayaan untuk mengetahui utilitasnya.
* Maka daripada itu, teori prospek hadir untuk melengkapi dari teori bernoulli dimana kita perlu variabel tambahan berupa titik rujukan. Dimana ada tiga fitur kognitif di inti teori prospek.
* Ketiga fitur kognitif ini dipandang sebagai ciri `Sistem 1` yang beroperasi.
